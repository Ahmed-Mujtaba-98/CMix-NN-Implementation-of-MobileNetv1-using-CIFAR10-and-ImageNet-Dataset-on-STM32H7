#ifndef __32_0_25_PARAMETERS_H__
#define __32_0_25_PARAMETERS_H__


/*
 * Convolution Layers
 *
 * Except 1st layer, all layers have zero padding.
 */
...
#define CONV1_L_PADDING 	(1)
#define CONV1_R_PADDING 	(1)
#define CONV1_T_PADDING 	(1)
...
#define CONV4_OUT_DIM    	(16)


/* Layer 5 Topology Parameters */
#define CONV5_IM_DIM    	(16)
...
#define CONV5_OUT_DIM    	(16)


/* Layer 6 Topology Parameters */
#define CONV6_IM_DIM    	(16)
...
#define CONV6_OUT_DIM    	(16)


/* Layer 7 Topology Parameters */
#define CONV7_IM_DIM    	(16)
...
#define CONV7_OUT_DIM    	(16)


/* Layer 8 Topology Parameters */
#define CONV8_IM_DIM    	(16)
...
#define CONV8_OUT_DIM    	(8)


/* Layer 9 Topology Parameters */
#define CONV9_IM_DIM    	(8)
...
#define CONV9_OUT_DIM    	(8)


/* Layer 10 Topology Parameters */
#define CONV10_IM_DIM    	(8)
...
#define CONV10_OUT_DIM    	(8)


/* Layer 11 Topology Parameters */
#define CONV11_IM_DIM    	(8)
...
#define CONV11_OUT_DIM    	(8)


/* Layer 12 Topology Parameters */
#define CONV12_IM_DIM    	(8)
...
#define CONV12_OUT_DIM    	(4)


/* Layer 13 Topology Parameters */
#define CONV13_IM_DIM    	(4)
...
#define CONV13_OUT_DIM    	(4)


/* Layer 14 Topology Parameters */
#define CONV14_IM_DIM    	(4)
...
#define CONV14_OUT_DIM    	(4)


/* Layer 15 Topology Parameters */
#define CONV15_IM_DIM    	(4)
...
#define CONV15_OUT_DIM    	(4)


/* Layer 16 Topology Parameters */
#define CONV16_IM_DIM    	(4)
...
#define CONV16_OUT_DIM    	(4)


/* Layer 17 Topology Parameters */
#define CONV17_IM_DIM    	(4)
...
#define CONV17_OUT_DIM    	(4)


/* Layer 18 Topology Parameters */
#define CONV18_IM_DIM    	(4)
...
#define CONV18_OUT_DIM    	(4)


/* Layer 19 Topology Parameters */
#define CONV19_IM_DIM    	(4)
...
#define CONV19_OUT_DIM    	(4)


/* Layer 20 Topology Parameters */
#define CONV20_IM_DIM    	(4)
...
#define CONV20_OUT_DIM    	(4)


/* Layer 21 Topology Parameters */
#define CONV21_IM_DIM    	(4)
...
#define CONV21_OUT_DIM    	(4)


/* Layer 22 Topology Parameters */
#define CONV22_IM_DIM    	(4)
...
#define CONV22_OUT_DIM    	(4)


/* Layer 23 Topology Parameters */
#define CONV23_IM_DIM    	(4)
...
#define CONV23_OUT_DIM    	(4)


/* Layer 24 Topology Parameters */
#define CONV24_IM_DIM    	(4)
...
#define CONV24_OUT_DIM    	(2)


/* Layer 25 Topology Parameters */
#define CONV25_IM_DIM    	(2)
...
#define CONV25_OUT_DIM    	(2)


/* Layer 26 Topology Parameters */
#define CONV26_IM_DIM    	(2)
...
#define CONV26_OUT_DIM    	(2)


/* Layer 27 Topology Parameters */
#define CONV27_IM_DIM    	(2)
...
#define CONV27_OUT_DIM    	(2)


/* Layer 28 Topology Parameters */
#define FC28_IM_CH     	(256)
#define FC28_OUT_CH    	(10)


#endif /*__32_0_25_PARAMETERS_H__*/
